<aside>
   <ul class="sidebar-navigation">
        ...
        <li><a href="{{url('me/obyavlenie')}}"><i class="fa fa-newspaper-o" aria-hidden="true"></i><span>Объявления</span></a></li>
        <li class="active"><a href="{{url('me/favorites/obyavlenie')}}"><i class="fa fa-list-ul" aria-hidden="true"></i></i><span>Избранные объявления</span></a></li>
