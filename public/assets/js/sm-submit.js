    ...
    $(document).ready(function() {
        ...
        function check(txt) {
            ...
            if (txt == "Частный дом" || txt == "Комната") {
                ...
                block("kolitchestvo_komnat", "Кол-во комнат");
            }
        ...
        var rooms = btn("kolitchestvo_komnat");
        setTitle("kolitchestvo_komnat", "Количество комнат");
        disableRel("kolitchestvo_komnat");

        //обработка нажатия по списку комнат
        $(".dropdown-menu li", $("[name=kolitchestvo_komnat]").parent()).on("click", function(ev) {
            setTitle("kolitchestvo_komnat", "Количество комнат");
        ...
        $(".dropdown-menu li", $("[name=rayon]").parent()).on("click", function(ev) {
