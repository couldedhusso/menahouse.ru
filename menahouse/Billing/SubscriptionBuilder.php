...
namespace Menahouse\Laravel\Cashier;
...
class SubscriptionBuilder
{
    ...
    public function quantity($quantity)
    {
        ...
        $this->endAtExpires = Carbon::now()->addMonth(); //($trialDays);
    ...
    //  * @return $this
    //  */
    // public function endAtDays($days)
    // {
    //     $this->endAtExpires = Carbon::now()->addDays($days);
    //     return $this;
    // }
